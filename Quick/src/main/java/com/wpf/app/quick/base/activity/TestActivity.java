...
public class TestActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        Log.e("TestActivity", "id=" + mRecyclerView + " R.id=" + R.id.recyclerView + " R2.id=" + R2.id.recyclerView + " name:" + Utils.getResourceEntryName(getWindow().getDecorView(), R.id.recyclerView));
    }
}
